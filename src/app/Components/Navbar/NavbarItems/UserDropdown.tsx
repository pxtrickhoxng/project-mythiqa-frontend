      ...
      {open && (
        <div className='absolute top-12 right-0 bg-white shadow-lg rounded-lg px-6 py-3 z-50 min-w-[220px] w-64 flex flex-col items-start gap-2'>
          ...
          <Link
            ...
            href={`/settings`}
          >
            <Image src='/settings.svg' alt='settings svg' width={20} height={20} className='mr-2' />
            <p>Settings</p>
          </Link>
          <button
            className='flex items-center gap-2 w-full px-3 py-2 rounded-md hover:bg-red-50 transition font-medium text-black mt-4'
            onClick={() => signOut()}
          >
