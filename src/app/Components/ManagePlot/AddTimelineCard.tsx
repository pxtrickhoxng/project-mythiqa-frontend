...
import { createTimelineCard } from '@/lib/api';
...
export default function AddTimelineCard({ bookId, userId, latestIndex }: PropTypes) {
  ...
  // states for the form
  const emptyEvent = { eventText: '', eventTextColor: '#000000', eventBgColor: '#ffffff' };
            ...
            <form onSubmit={handleSubmit}>
              {hasFailed && (
                <div className='mb-4 p-3 bg-red-50 border border-red-200 rounded-md'>
                  <div className='flex items-center'>
                    ...
                    <p className='text-sm text-red-700 font-medium'>Failed to save timeline event. Please try again.</p>
                    <button
                      type='button'
              ...
              <div className='flex justify-between items-start mb-4'>
                ...
                <div className='flex space-x-2'>
                  ...
                  <button type='button' className='text-gray-600 hover:text-gray-800' onClick={() => setIsOpen(false)}>
                    Cancel
                  </button>
                </div>
              </div>
