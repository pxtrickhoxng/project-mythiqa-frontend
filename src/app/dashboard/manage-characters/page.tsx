        ...
        const fakeData: Character[] = [
          {
            ...
            speechPatterns:
              "Speaks in measured, poetic tones with frequent nature metaphors",
            appearance: {
              height: "5'9\"",
            ...
            backstory:
              "Born during a lunar eclipse to the High Priestess of the Twilight Council...",
            generalNotes:
              "Aria possesses rare shadow-weaving abilities, making her crucial in the coming conflict...",
          ...
          },
          {
            ...
            speechPatterns:
              "Direct and formal speech, often using military terminology",
            appearance: {
              height: "6'2\"",
            ...
            backstory:
              "Former captain of the city guard who lost his arm defending the city from a demon invasion...",
            generalNotes:
              "Despite his gruff exterior, Marcus has a soft spot for helping street orphans...",
          ...
          },
          {
            ...
            speechPatterns:
              "Rapid-fire speech pattern with frequent scientific jargon and void-related metaphors",
            appearance: {
              height: "5'7\"",
            ...
            backstory:
              "A brilliant scientist whose experiments with void energy led to a transformation...",
            generalNotes:
              "Her pursuit of void knowledge threatens to unravel reality itself...",
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-12rem)] bg-white rounded-lg shadow-sm mx-6 my-6">
        ...
        <p className="text-gray-600 text-center mb-8 max-w-md">
          You haven&apos;t created any characters yet. Create your first
          character to begin your storytelling journey!
        </p>
        <Link
