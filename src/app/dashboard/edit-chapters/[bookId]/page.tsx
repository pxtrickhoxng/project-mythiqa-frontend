          ...
          <div className='bg-white rounded-lg shadow-sm border border-gray-200'>
            <div className='px-6 py-8 border-b border-gray-200'>
              <div className='flex items-center justify-between'>
                <div>
                  <h2 className='text-2xl font-semibold text-gray-800 mb-2'>{book.bookName}</h2>
            ...
            {sortedChapters.length > 0 ? (
                      ...
                      <div className='flex items-start gap-4 flex-1'>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          <div className='flex items-center gap-4 text-sm text-gray-500'>
                            <span>Published {formatDate(chapter.createdAt)}</span>
                          </div>
                        </div>
                      </div>
              ...
              <div className='p-12 text-center'>
                ...
                <h3 className='text-xl font-semibold text-gray-700 mb-2'>No chapters yet!</h3>
                <p className='text-gray-500 mb-6'>Create your first chapter to get started with your story.</p>
                <Link
                  href={`/dashboard/create/new-chapter/${book.bookId}`}
    ...
    return (
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center max-w-md'>
          <p className='text-red-500 text-lg font-medium mb-2'>Error loading chapters</p>
