import { fetchBookData, fetchBookChapters } from "@/lib/api/books";
...
const page = async ({ params }: PageProps) => {
  ...
  try {
    const [bookRes, chaptersRes] = await Promise.all([
      fetchBookData(bookId, token),
      fetchBookChapters(bookId, token),
    ]);
                ...
                {chapters.length > 0 ? (
                  ...
                  <div className="p-8 text-center">
                    ...
                    <p className="text-gray-500">
                      The author hasn&apos;t published any chapters for this
                      story.
                    </p>
                  </div>
                )}
